TauCharts is a javascript graph library. It is based on D3 framework. So why you need it? There are handful of similar libraries, but TauCharts has some unique features.
